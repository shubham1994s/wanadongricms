...
{
    public class AppAreaMapsGridRepository: IDataTableRepository
    {
        IEnumerable<SBAAppAreaMapGridRow> dataSet;
        DashBoardRepository objRep = new DashBoardRepository();

        public AppAreaMapsGridRepository(long wildcard, string SearchString, int appId)
        {
            dataSet = objRep.AppAreaMapsData(wildcard, SearchString, appId);
        }
