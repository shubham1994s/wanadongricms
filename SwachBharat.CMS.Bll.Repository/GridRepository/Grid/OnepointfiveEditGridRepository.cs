...
namespace SwachBharat.CMS.Bll.Repository.GridRepository.Grid
{
     ...
     public class OnepointfiveEditGridRepository : IDataTableRepository
    {
        IEnumerable<OnePointfourGridRow> dataset;
        DashBoardRepository objRep = new DashBoardRepository();

        public OnepointfiveEditGridRepository(long wildcard, string SearchString, int AppId, string INSERT_ID)
        {
