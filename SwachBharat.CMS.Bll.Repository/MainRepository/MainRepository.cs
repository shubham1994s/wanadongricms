        ...
        public List<MenuItem> GetMenus()
        {
            ...
            using (DevSwachhBharatMainEntities db = new DevSwachhBharatMainEntities())
            {
                ...
                var W = db.AppConnections.Join(db.AppDetails, a => a.AppId, b => b.AppId,
                    (a, b) => new { AppId = a.AppId, AppName = b.AppName, IsActive = b.IsActive ,FAQ = b.FAQ })
                    .Join(db.UserInApps, c => c.AppId, d => d.AppId,
                    (c, d) => new { c, d })
                    .Join(db.AspNetUsers, e => e.d.UserId, f => f.Id,
                    (e, f) => new MenuItem { M_ID = 1, M_P_ID = 1, ActionName = "Login", ControllerName = "Account", LinkText = e.c.AppName, FAQ =e.c.FAQ ,returnUrl = f.UserName, Type = "W", isActive = e.c.IsActive }).Where(x => x.isActive == true).ToList();
                ...
                var L = db.AppConnections.Join(db.AppDetails, a => a.AppId, b => b.AppId,
                    ...
                    (c, d) => new MenuItem { M_ID = 1, M_P_ID = 2, ActionName = "Login", ControllerName = "Account", LinkText = c.AppName, FAQ = c.FAQ, returnUrl = d.ADUM_LOGIN_ID, Type = "L", isActive = c.IsActive }).Where(x => x.isActive == true).ToList();
                ...
                var S = db.AppConnections.Join(db.AppDetails, a => a.AppId, b => b.AppId,
                    ...
                    (c, d) => new MenuItem { M_ID = 1, M_P_ID = 3, ActionName = "Login", ControllerName = "Account", LinkText = c.AppName, FAQ = c.FAQ, returnUrl = d.ADUM_LOGIN_ID, Type = "S", isActive = c.IsActive }).Where(x => x.isActive == true).ToList();
