...
{
    public class DumpPlantProcessController : Controller
    {

        IMainRepository mainRepository;
        IChildRepository childRepository;
        public DumpPlantProcessController()
        {
        ...
        public ActionResult DumpUserRoute(int daId)
        {
            if (SessionHandler.Current.AppId != 0)
            {
                ViewBag.daId = daId;
        ...
        public ActionResult DumpUserRouteData(int daId)
        {
            if (SessionHandler.Current.AppId != 0)
            {
                List<SBALUserLocationMapView> obj = new List<SBALUserLocationMapView>();
        ...
        public ActionResult DumpRoute(int daId)
        {
        ...
        public ActionResult DumpRouteData(int daId)
        {
            if (SessionHandler.Current.AppId != 0)
            {

                List<SBALUserLocationMapView> obj = new List<SBALUserLocationMapView>();
                obj = childRepository.GetDumpAttenRoute(daId);
                // return Json(obj);
