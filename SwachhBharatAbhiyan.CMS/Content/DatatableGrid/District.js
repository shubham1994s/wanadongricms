$(document).ready(function () {
    $("#demoGrid").DataTable({
        ...
        "ajax": {
            "url": "/Datable/GetJqGridJson?rn=DistrictDetail",
            "type": "POST",
            "datatype": "json"
        },
...
function Edit(Id) {
    ...
    if (Id != null) {
        var url = "/MainMaster/AddDistrictDetails?teamId=" + Id;
...
function Delete(Id) {
    if (Id != null && Id != '') {
        ...
        if (confirm("Do you want delete selected District?")) {
            var url = "/MainMaster/DeleteDistrict?teamId=" + Id;
            window.location.href = url;
        }
    }
};
