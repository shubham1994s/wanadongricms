$(document).ready(function () {
    $("#demoGrid").DataTable({
        ...
        "ajax": {
            "url": "/Datable/GetJqGridJson?rn=onepointfourDetail",
            "type": "POST",
            "datatype": "json"
        },
        "columnDefs":
...
function View(INSERT_ID) {
    if (INSERT_ID != null) {
        var url = "/Report/OnePointfour2020?INSERT_ID=" + INSERT_ID;
...
function Edit(INSERT_ID) {
    if (INSERT_ID != null) {
        var url = "/Report/MenuOnePointFourDetails?INSERT_ID=" + INSERT_ID;
        window.location.href = url;
    }
};
