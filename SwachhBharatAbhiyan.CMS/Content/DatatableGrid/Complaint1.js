        ...
        },
            {
                ...
                "render": function (data, type, full, meta) {
                    if (full["status"] != "Complete") {
                        return "<a style='color:#0056b3; font-weight:700;cursor:pointer;' onclick=StatusPopup(" + full['complaintId'] + ") >" + data + "</a>";
                    }
                    else {
              ...
              { "data": "status", "name": "status", "autoWidth": true },           
               {
                   "data": "startImage", "name": "startImage", "render": function (data, type, full, meta) {
                       ...
                       + full["address"] + "</li><li style='display:none' class='li_title' > फोटो / Photo </li></ul></span></div>";
                           }
               },
...
function assignValue2(Id) {
    var url = '/GPCleaningComplient/EditDetails?teamId=' + Id;
...
function Search() {
    ...
    var Product = "";
    var catProduct = "";
    var value = txt_fdate + "," + txt_tdate + "," + UserId;//txt_fdate + "," + txt_tdate + "," + UserId + "," + Client + "," + NesEvent + "," + Product + "," + catProduct + "," + 1;
    // alert(value );
