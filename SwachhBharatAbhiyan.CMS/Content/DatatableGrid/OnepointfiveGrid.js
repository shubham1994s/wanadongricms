$(document).ready(function () {
    $("#demoGrid").DataTable({
        ...
        "ajax": {
            "url": "/Datable/GetJqGridJson?rn=onepointfiveDetail",
            "type": "POST",
            "datatype": "json"
        },
        "columnDefs":
...
function View(INSERT_ID) {
    if (INSERT_ID != null) {
        var url = "/Report/OnePointfive20201?INSERT_ID=" + INSERT_ID;
...
function Edit(INSERT_ID) {
    if (INSERT_ID != null) {
        var url = "/Report/MenuOnePointFiveDetails?INSERT_ID=" + INSERT_ID;
        window.location.href = url;
    }
};
