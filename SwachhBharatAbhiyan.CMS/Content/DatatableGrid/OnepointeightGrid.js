$(document).ready(function () {
    $("#demoGrid").DataTable({
        ...
        "ajax": {
            "url": "/Datable/GetJqGridJson?rn=onepointeightDetail",
            "type": "POST",
            "datatype": "json"
        },
        "columnDefs":
...
function View(INSERT_ID) {
    if (INSERT_ID != null) {
        var url = "/Report/OnePointeight20201?INSERT_ID=" + INSERT_ID;
...
function Edit(INSERT_ID) {
    if (INSERT_ID != null) {
        var url = "/Report/MenuOnePointeightDetails?INSERT_ID=" + INSERT_ID;
        window.location.href = url;
    }
};
