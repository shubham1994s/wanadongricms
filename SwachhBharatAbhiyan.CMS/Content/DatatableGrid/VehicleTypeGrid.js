$(document).ready(function () {
    $("#demoGrid").DataTable({
        ...
        "ajax": {
            "url": "/Datable/GetJqGridJson?rn=VehicleDetail",
            "type": "POST",
            "datatype": "json"
        },
        ...
        "columns": [
              ...
              { "data": "Name", "name": "Name", "autoWidth": false, "width": "25%" },
              { "data": "NameMar", "name": "NameMar", "autoWidth": false, "width": "25%" },
              { "data": "isActive", "name": "isActive", "autoWidth": false, "width": "25%" },
...
function Edit(Id) {
    ...
    if (Id != null) {
        var url = "/MainMaster/AddVehicleDetails?teamId=" + Id;
