        ...
        (DateFormatter.prototype = {
            ...
            parseDate: function (t, a) {
                var r,
                    ...
                    g = !1,
                    p = m.dateSettings,
                    y = { date: null, year: null, month: null, day: null, hour: null, min: null, sec: null };
                if (!t) return void 0;
                    ...
                    switch (((i = n[o]), (s = parseInt(i)), r[o])) {
                        ...
                        case "h":
                            (u = r.indexOf("a") > -1 ? r.indexOf("a") : r.indexOf("A") > -1 ? r.indexOf("A") : -1),
                                (c = n[u]),
                                u > -1 ? ((l = e(c, p.meridiem[0]) ? 0 : e(c, p.meridiem[1]) ? 12 : -1), s >= 1 && 12 >= s && l > -1 ? (y.hour = s + l - 1) : s >= 0 && 23 >= s && (y.hour = s)) : s >= 0 && 23 >= s && (y.hour = s),
                                (g = !0);
                            break;
                        case "G":
                        case "H":
                            ...
                            return (
                                C.startDate
                                    ...
                                    : ((t = C.value || (a && a.val && a.val() ? a.val() : "")),
                                        t ? (t = j.strToDateTime(t)) : C.defaultDate && ((t = j.strToDateTime(C.defaultDate)), C.defaultTime && ((e = j.strtotime(C.defaultTime)), t.setHours(e.getHours()), t.setMinutes(e.getMinutes())))),
                                ...
                                (r(t.mask, a.val()) || (a.val(t.mask.replace(/[0-9]/g, "_")), o(a[0], 0)),
                                    a.on("keydown.xdsoft", function (i) {
                                        ...
                                        if ((C >= l && f >= C) || (C >= c && m >= C) || C === v || C === g) {
                                            for (
                                                s = n(this), d = C !== v && C !== g ? String.fromCharCode(C >= c && m >= C ? C - l : C) : "_", (C !== v && C !== g) || !s || ((s -= 1), (d = "_"));
                        ...
                        C.id && J.attr("id", C.id),
                            ...
                            N.find(".xdsoft_month,.xdsoft_year").on("touchstart mousedown.xdsoft", function (t) {
                                var a,
                                    ...
                                    s = n.is(":visible");
                                for (
                                    N.find(".xdsoft_select").hide(), j.currentTime && (o = j.currentTime[e(this).hasClass("xdsoft_month") ? "getMonth" : "getFullYear"]()), n[s ? "hide" : "show"](), a = n.find("div.xdsoft_option"), r = 0;
                                        ...
                                        e.each(n.highlightedPeriods, function (a, n) {
                                            ...
                                            for (; s >= i;)
                                                (u = new t(i, d, c)),
                                                    ...
                                                    void 0 !== o[l] ? ((f = o[l].desc), f && f.length && u.desc && u.desc.length && (o[l].desc = f + "\n" + u.desc)) : (o[l] = u);
                                        }),
                                        (C.highlightedDates = e.extend(!0, [], o))),
                            ...
                            (d = function () {
                                ...
                                (t.now = function (e) {
                                    ...
                                    return (
                                        ...
                                        !e && C.defaultTime && ((r = t.strtotime(C.defaultTime)), n.setHours(r.getHours()), n.setMinutes(r.getMinutes())),
                                        n
                                    );
                                }),
                            ...
                            E.find(".xdsoft_prev,.xdsoft_next").on("touchend mousedown.xdsoft", function () {
                                ...
                                !(function o(e) {
                                    ...
                                    t.hasClass(C.next) && s - i - C.timeHeightInTimePicker >= d
                                        ? B.css("marginTop", "-" + (d + C.timeHeightInTimePicker) + "px")
                                        : t.hasClass(C.prev) && d - C.timeHeightInTimePicker >= 0 && B.css("marginTop", "-" + (d - C.timeHeightInTimePicker) + "px"),
                                        R.trigger("scroll_element.xdsoft_scroller", [Math.abs(parseInt(B[0].style.marginTop, 10) / (s - i))]),
                                        (n = n > 10 ? 10 : n - 10),
                            ...
                            J.on("xchange.xdsoft", function (t) {
                                clearTimeout(u),
                                    (u = setTimeout(function () {
                                        ...
                                        for (
                                            var t, i, s, d, u, l, f, c, m, h, g = "", p = new Date(j.currentTime.getFullYear(), j.currentTime.getMonth(), 1, 12, 0, 0), y = 0, v = j.now(), b = !1, D = !1, k = [], x = !0, T = "", S = "";
                                        ...
                                        for (
                                            g += "</tr></thead>",
                                            g += "<tbody>",
                                            C.maxDate !== !1 && ((b = j.strToDate(C.maxDate)), (b = new Date(b.getFullYear(), b.getMonth(), b.getDate(), 23, 59, 59, 999))),
                                            C.minDate !== !1 && ((D = j.strToDate(C.minDate)), (D = new Date(D.getFullYear(), D.getMonth(), D.getDate())));
                                            y < j.currentTime.countDaysInMonth() || p.getDay() !== C.dayOfWeekStart || j.currentTime.getMonth() === p.getMonth();
                                            ...
                                            (k = []),
                                                ...
                                                C.allowDateRe && "[object RegExp]" === Object.prototype.toString.call(C.allowDateRe)
                                                    ? C.allowDateRe.test(r.formatDate(p, C.formatDate)) || k.push("xdsoft_disabled")
                                                    : C.allowDates && C.allowDates.length > 0
                                                        ? -1 === C.allowDates.indexOf(r.formatDate(p, C.formatDate)) && k.push("xdsoft_disabled")
                                                        : (b !== !1 && p > b) || (D !== !1 && D > p) || (c && c[0] === !1)
                                                            ? k.push("xdsoft_disabled")
                                                            : -1 !== C.disabledDates.indexOf(r.formatDate(p, C.formatDate))
                                                                ? k.push("xdsoft_disabled")
                                                                : -1 !== C.disabledWeekDays.indexOf(s)
                                                                    ? k.push("xdsoft_disabled")
                                                                    : a.is("[readonly]") && k.push("xdsoft_disabled"),
                                                c && "" !== c[1] && k.push(c[1]),
                                                j.currentTime.getMonth() !== l && k.push("xdsoft_other_month"),
                                                (C.defaultSelect || J.data("changed")) && r.formatDate(j.currentTime, C.formatDate) === r.formatDate(p, C.formatDate) && k.push("xdsoft_current"),
                                                r.formatDate(v, C.formatDate) === r.formatDate(p, C.formatDate) && k.push("xdsoft_today"),
                                                (0 === p.getDay() || 6 === p.getDay() || -1 !== C.weekends.indexOf(r.formatDate(p, C.formatDate))) && k.push("xdsoft_weekend"),
                                                void 0 !== C.highlightedDates[r.formatDate(p, C.formatDate)] &&
                                                ((i = C.highlightedDates[r.formatDate(p, C.formatDate)]), k.push(void 0 === i.style ? "xdsoft_highlighted_default" : i.style), (h = void 0 === i.desc ? "" : i.desc)),
                                                C.beforeShowDay && e.isFunction(C.beforeShowDay) && k.push(C.beforeShowDay(p)),
                                                x && ((g += "<tr>"), (x = !1), C.weeks && (g += "<th>" + f + "</th>")),
                                                (g +=
                                                    '<td data-date="' +
                                                    d +
                                                    '" data-month="' +
                                            ...
                                            ((g += "</tbody></table>"),
                                                ...
                                                (m = function (t, n) {
                                                    ...
                                                    s.setHours(t),
                                                        ...
                                                        o.setMinutes(n),
                                                        (k = []),
                                                        (C.minDateTime !== !1 && C.minDateTime > o) || (C.maxTime !== !1 && j.strtotime(C.maxTime).getTime() < s.getTime()) || (C.minTime !== !1 && j.strtotime(C.minTime).getTime() > s.getTime())
                                                            ? k.push("xdsoft_disabled")
                                                            : (C.minDateTime !== !1 && C.minDateTime > o) ||
                                                                (C.disabledMinTime !== !1 && s.getTime() > j.strtotime(C.disabledMinTime).getTime() && C.disabledMaxTime !== !1 && s.getTime() < j.strtotime(C.disabledMaxTime).getTime())
                                                                ? k.push("xdsoft_disabled")
                                                                : a.is("[readonly]") && k.push("xdsoft_disabled"),
                                                        ...
                                                        ((!d && C.step > 59) || i.getMinutes() === parseInt(n, 10)) &&
                                                        (C.defaultSelect || J.data("changed") ? k.push("xdsoft_current") : C.initTime && k.push("xdsoft_init_time")),
                                                        parseInt(v.getHours(), 10) === parseInt(t, 10) && parseInt(v.getMinutes(), 10) === parseInt(n, 10) && k.push("xdsoft_today"),
                                                        (T += '<div class="xdsoft_time ' + k.join(" ") + '" data-hour="' + t + '" data-minute="' + n + '">' + r.formatDate(s, C.formatTime) + "</div>");
                                                }),
                                    ...
                                    B.find(".xdsoft_current").length ? (e = ".xdsoft_current") : B.find(".xdsoft_init_time").length && (e = ".xdsoft_init_time"),
                                        e
                                            ? ((t = R[0].clientHeight),
                                                ...
                                                r > a - t && (r = a - t),
                                                R.trigger("scroll_element.xdsoft_scroller", [parseInt(r, 10) / (a - t)]))
                            ...
                            B.on("touchend click.xdsoft", "div", function (t) {
                                ...
                                var a = e(this),
                                    r = j.currentTime;
                                return (
                                    (void 0 === r || null === r) && ((j.currentTime = j.now()), (r = j.currentTime)),
                            ...
                            a.on("mousewheel.xdsoft", function (e) {
                                return C.scrollInput
                                    ? !C.datepicker && C.timepicker
                                        ? ((A = B.find(".xdsoft_current").length ? B.find(".xdsoft_current").eq(0).index() : 0),
                                            A + e.deltaY >= 0 && A + e.deltaY < B.children().length && (A += e.deltaY),
                                            B.children().eq(A).length && B.children().eq(A).trigger("mousedown"),
                                            !1)
                                        : C.datepicker && !C.timepicker
                                            ? (I.trigger(e, [e.deltaY, e.deltaX, e.deltaY]), a.val && a.val(j.str()), J.trigger("changedatetime.xdsoft"), !1)
                                            : void 0
                                    : !0;
                            }),
